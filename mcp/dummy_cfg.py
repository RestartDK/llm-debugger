"""
Hardcoded control-flow graph payload used for the temporary
`/get_control_flow_diagram` endpoint response.

TODO: Replace with dynamically generated graph output once the pipeline
is wired in.
"""
